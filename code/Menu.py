...
class Menu:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(text_size= 50, text_color=COLOR_WHITE, text="Mountain",  text_center_pos=((WIN_WIDTH /2) ,70))
            self.menu_text(text_size= 50, text_color=COLOR_WHITE, text= "Shooter", text_center_pos=((WIN_WIDTH / 2), 120))
